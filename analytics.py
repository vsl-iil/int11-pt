...
# Модуль аналитики содержит списки различных видов вредносного, нежелательного и потенциально опасного ПО, взятых из docx-файла, приложенного к заданию. Списки разбиты на три категории - угрозы низкой, средней и высокой опасности. 
# В зависимости от того, какая из трёх категорий преобладает в списке видов для конкретного образца, выносится один из трёх уровней опасности. 
# Изначальный список формируется в main.py при помощи функции get_malware_class из importer.py, который сопоставляет виды с APT ETDA с видами из docx-файла.
